        ...
        <div class="esoftcreator-layout" id="esoftcreator-sales-report">
          <div class="esoftcreator-main-section">
            <div class="esoftcreator-main-section-header">
              <h2 class="esoftcreator-main-section-header__title esoftcreator-main-section-header__header-item"><?php _e("Woocommerce order reports overview","e-soft-creator"); ?></h2>
