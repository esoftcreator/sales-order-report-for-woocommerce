...
if(!class_exists('Esoftcreator_Sales_Analysis')):
    ...
    public function current_js(){
      ...
      (function($){
        jQuery(document).ready(function(){
          //$(function() {
            var start = moment().subtract(230, 'days');
            var end = moment();
    ...
    public function current_html(){
      ...
      $result = $this->Esoftcreator_DB_Helper->get_dashboard_data($start_date, $today_date);
        ...
        <div class="esoftcreator-layout" id="esoftcreator-sales-analysis">
          <div class="esoftcreator-main-section">
            <div class="esoftcreator-main-section-header">
              <h2 class="esoftcreator-main-section-header__title esoftcreator-main-section-header__header-item"><?php _e("Woocommerce slaes order analysis","e-soft-creator"); ?></h2>
                    ...
                    <div class="col">
                      <div class="card disapproved"  id="s1_shipping">
                        ...
                        <div class="shipping-chart" id="s1_shipping_chart">
                          <canvas id="shipping_chart" width="400" height="400"></canvas>
                        </div>                       
                      </div>
                    </div>
                    <div class="col">
                      <div class="card approved" id="s1_order_status">
                        <h3 class="pro-count sales-smry-value">-</h3>
                        <p class="pro-title sales-smry-title"><?php _e("Orders Status","e-soft-creator"); ?></p>
